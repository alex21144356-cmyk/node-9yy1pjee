...
const ROLE_CONFIG = {
  1: { x: 100, color: '#ff0055', facing: 1 },
  2: { x: 300, color: '#00f0ff', facing: 1 },
  3: { x: 500, color: '#00ff66', facing: -1 },
  4: { x: 700, color: '#ffcc00', facing: -1 },
};
...
// ============== MAPAS ==============
const MAPS = [
  { name: 'Arena Clásica', bg: '#090d16', floorColor: '#1e293b', floorSegments: [[0, 800]], platforms: [] },
  {
    name: 'Templo de Piedra', bg: '#171210', floorColor: '#44403c', floorSegments: [[0, 800]],
    platforms: [{ x: 140, y: 300, width: 150, height: 16 }, { x: 510, y: 300, width: 150, height: 16 }],
  },
  {
    name: 'Plataformas Flotantes', bg: '#0b1329', floorColor: '#334155', floorSegments: [[0, 800]],
    platforms: [{ x: 70, y: 320, width: 120, height: 16 }, { x: 340, y: 250, width: 120, height: 16 }, { x: 610, y: 320, width: 120, height: 16 }],
  },
  { name: 'Volcán Cyber', bg: '#230b0b', floorColor: '#991b1b', floorSegments: [[0, 800]], platforms: [{ x: 250, y: 310, width: 300, height: 16 }] },
  {
    name: 'Hielo Eterno', bg: '#0a192f', floorColor: '#38bdf8', floorSegments: [[0, 800]],
...
io.on('connection', (socket) => {
  ...
  const cfg = ROLE_CONFIG[role] || { x: 400, color: '#94a3b8', facing: 1 };
...
function empaquetarEstado() {
  ...
  for (let id in players) {
    ...
    optPlayers[id] = {
      ...
      health: p.health, facing: p.facing, isAttacking: p.isAttacking,
